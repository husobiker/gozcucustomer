-- Corporate Settings Tablosu Oluşturma
-- Bu tablo firma bilgilerini saklamak için kullanılır
...
-- Bu kısmı sadece test için kullanabilirsiniz
/*
INSERT INTO corporate_settings (
    tenant_id,
    company_name,
    company_full_name,
    company_address,
    ...
    'your-tenant-id-here', -- Bu kısmı gerçek tenant ID ile değiştirin
    'ABC Güvenlik Hizmetleri',
    'ABC Güvenlik Hizmetleri Ltd. Şti.',
    'Örnek Mahallesi Güvenlik Sokak No:1 Pendik İstanbul 34912',
    '+90 216 123 45 67',
    'info@abcguvenlik.com',
    'www.abcguvenlik.com',
    '1234567890',
    ...
    '#42a5f5',
    '#ff9800',
    '© 2024 Gözcü360°. Tüm hakları saklıdır.',
    'Europe/Istanbul',
    'DD/MM/YYYY',
    '24',
    'TRY',
    'tr',
    'ABC Güvenlik - Özel Güvenlik Hizmetleri',
    'ABC Güvenlik ile güvenlik hizmetlerinizi profesyonel şekilde yönetin.',
    'güvenlik, özel güvenlik, tesis yönetimi, abc güvenlik'
...
-- WHERE table_name = 'corporate_settings' 
