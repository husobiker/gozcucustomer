...
Aşağıdaki SQL kodunu kopyala ve SQL Editor'da çalıştır:
...
- Süper admin: http://localhost:3000?admin=true

## ✅ Başarılı Kurulum Kontrolü

1. **Tablolar Oluştu**: `tenants`, `users`, `projects`, `personnel`, `checkpoints`, `patrols`, `incidents`
2. **RLS Aktif**: Her tablo için Row Level Security politikaları
3. **Fonksiyonlar**: `set_tenant_context`, `get_current_tenant_id`
4. **Demo Veri**: ABC Güvenlik ve XYZ Güvenlik tenant'ları
...
- RLS fonksiyonlarını tekrar çalıştır
- Supabase'de "Database" > "Functions" bölümünü kontrol et

### "Permission denied" Hatası

- RLS politikalarını kontrol et
- Supabase'de "Authentication" > "Policies" bölümünü kontrol et
